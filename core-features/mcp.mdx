---
title: "MCP Server"
description: "Learn how to access BuildWithAI documentation directly through Windsurf using the Model Context Protocol"
icon: "zap"
---
...
If you prefer using Cursor instead of Windsurf, you can easily add the BuildWithAI MCP server to Cursor:
