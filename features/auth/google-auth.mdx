...
<Warning>
  **App Store Requirement**: Apple requires that if you implement any third-party authentication in your iOS app, you **must** also implement Apple Sign-In to pass App Store review. See our [Apple Sign-In guide](/features/auth/apple-auth).
</Warning>
