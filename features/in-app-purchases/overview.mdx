...
description: "An overview of implementing in-app purchases and subscriptions in your app"
---

## Introduction

This guide provides a comprehensive overview of implementing in-app purchases and subscriptions in your app. We'll cover the entire process from setting up your app in the app stores to testing purchases.
...
### 4. Integration
- [RevenueCat Setup](./revenuecat) - Configure your RevenueCat account
- [Import Products to RevenueCat](./import-products-rc) - Import your products from app stores
- [Superwall Setup](./superwall) - Configure paywalls and A/B testing
