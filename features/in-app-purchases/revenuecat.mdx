...
- Configured your apps in App Store Connect and/or Google Play Console
- The same bundle ID and package name for both platforms
- Access to your Apple Developer and Google Play Console accounts
...
- [Create subscription products](./ios-products) in App Store Connect
- [Create subscription products](./android-products) in Google Play Console
- [Import products into RevenueCat](./import-products-rc)
