---
title: "iOS Sandbox Testing"
description: "Set up sandbox testing for your iOS app to test in-app purchases"
---

## Prerequisites

Before setting up sandbox testing, make sure you have:

- Completed the [App Store Connect Setup](./app-store-connect-setup) for your app
- Created subscription products in [App Store Connect](./ios-products)
- A development build of your app installed on your iOS device
...
With your sandbox testing environment set up, you can now:

1. [Set up RevenueCat](./revenuecat) for subscription management
2. [Import your products into RevenueCat](./import-products-rc)
3. [Configure Superwall](./superwall) for paywall management