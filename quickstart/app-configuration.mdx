...
| Setting | What It Is | Example | Format |
|---------|------------|---------|--------|
| **name** | Display name in stores | `"Travel App"` | Normal words with spaces |
| **slug** | URL identifier | `"travel-app"` | lowercase-with-hyphens |
| **scheme** | Deep link code | `"travelapp"` | lowercaseletters |
| **bundleIdentifier** | Unique app address | `"com.johndoe.travelapp"` | `com.[identifier].[slug]` |
| **package** | Same as bundleIdentifier | `"com.johndoe.travelapp"` | Must match exactly |
